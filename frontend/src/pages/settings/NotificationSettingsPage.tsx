    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      <div>
        <h1 className="text-2xl font-extrabold text-slate-900 dark:text-white tracking-tight flex items-center space-x-2.5">
          <BellRing className="w-7 h-7 text-emerald-500" />
          <span>Notification & Alert Settings</span>
        </h1>
        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
          Configure automated in-app alerts, upcoming contribution reminders, and future Email/SMS gateways.
        </p>
      </div>
      ...
      <Card
        title="Event Trigger & Dispatch Rules"
        subtitle="Manage which business events trigger automated warnings and notifications."
      >
        {loading ? (
